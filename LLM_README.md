...
TASK-268 is active on PR 253: the built image's production launcher path is green through the authenticated host supervisor and real Docker; item 5.11's two negative images, full gate, and review remain.
