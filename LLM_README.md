...
Active: TASK-268 on PR 253 has exact-once Retry plus solver mapping and durable poller hardening green; next run full gates and independent review. TASK-289 on PR 251 hardens CI annotations; h2puni gate and fail-closed control are green.
