...
| `docs/2026-09-02-refactoring-plan.md`, `docs/2026-09-05-ports-and-adapters-plan.md` | before any refactor — five waves and ledgers; then the core / store-sqlite / store-memory / be-01 split, ADR 0014–0015; its `-history.md` is not normative. **Status and queue: `docs/refactoring/tasks.md`** |
