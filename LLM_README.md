...
Active: TASK-268 on PR 253 has image/orphan/eviction proofs plus the exact-once, authorized Retry route green; remaining hardening follows the open OpenSpec checklist. TASK-289 on PR 251 hardens CI annotations; h2puni gate and fail-closed control are green.
