...
Active TASK-220: `change/optimized-scheduler-coordinator`, PR 216; next two-coordinator OFF-cancel proof, then durable FIFO admission. Do not merge or install the host service.
