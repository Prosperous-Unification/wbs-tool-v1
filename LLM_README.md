...
TASK-543's deadline-ledger follow-up is on `fix/task-543-deadline-ledger-followups`; next: exact-head gate, terminal reviews, green CI, merge, and dev verification.
