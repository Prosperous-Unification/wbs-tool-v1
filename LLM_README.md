...
Active: TASK-268 on PR 253 has image/orphan/eviction, exact-once Retry, and outcome-event negatives green; remaining UI/gate hardening follows the open OpenSpec checklist. TASK-289 on PR 251 hardens CI annotations; h2puni gate and fail-closed control are green.
