...
TASK-300 keeps literal tabs fail-closed in restored CI annotations, preserves encoded `%09`, and records the exact splitter-only and guard-only watched failures.
