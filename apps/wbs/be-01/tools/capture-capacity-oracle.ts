 ...
 *
 *     bun apps/wbs/be-01/tools/capture-capacity-oracle.ts > \
 *       apps/wbs/be-01/src/service/fixtures/capacity-oracle-2026-08-13.json
 *
 * It lives in `apps/wbs/be-01/tools` rather than in `tools/dev` because it imports
