 ...
 * this function. `diffSchedule` in `libs/wbs/domain/domain` emits `schedule.present` only
 ...
 * `PlanDiffCategory` in `libs/wbs/domain/domain` is a **type error here** rather than a
