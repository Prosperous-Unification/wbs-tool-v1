 ...
 * it differently.** Fast's comparator (`libs/wbs/domain/domain/src/schedule.ts`) asks
 ...
 * (`libs/wbs/adapters/solver-py/src/wbs_solver/model.py`), a CP-SAT constraint whose
