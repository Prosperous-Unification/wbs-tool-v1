 ...
 * loose
 * ```
 * The fixture of `libs/wbs/application/core/src/service/dependency.test.ts`, so the cases below
...
/**
 * Every `canDepend` case from `libs/wbs/application/core/src/service/dependency.test.ts`, with
