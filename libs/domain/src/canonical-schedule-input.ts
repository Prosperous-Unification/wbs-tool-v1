 ...
 * empty map and the entry canonicalizes to `[]`. That empty state is a
 * *proved* state rather than a placeholder: 1.6's and 4.3's no-op proof requires
 * the seventh argument to leave every golden corpus case byte-identical, and
