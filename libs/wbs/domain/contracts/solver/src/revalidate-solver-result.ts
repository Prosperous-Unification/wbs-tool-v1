 ...
 * R5 names. Each row below was RUN on h2puni against `libs/wbs/domain/contracts` — the
 ...
 * is in `apps/wbs/be-01`: reverting `evaluateSolverOutcome` to the pre-TASK-329
 ...
 * the third copy of a predicate `libs/wbs/domain/domain/src/on-time.ts` exists to hold
