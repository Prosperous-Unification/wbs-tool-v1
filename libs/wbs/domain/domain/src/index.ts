...
// Moved out of `apps/wbs/be-01/src/service/` on 2026-09-02. Both were already pure —
...
// `libs/wbs/domain/contracts` proves a property ABOUT them: that materialising the
