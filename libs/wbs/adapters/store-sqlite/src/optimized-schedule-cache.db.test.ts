...
describe('a plan through the column it is stored in', () => {
  /**
   * tasks.md 4.12's watched red, the half `libs/wbs/domain/domain`'s own cases cannot
   ...
   * `libs/wbs/domain/contracts/solver` had no path alias at all, so the decoder 4.1's read
   * half has to call could not be named from `apps/wbs/be-01` by anything but a
