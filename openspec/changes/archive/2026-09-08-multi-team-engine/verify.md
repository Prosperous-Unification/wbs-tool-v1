...
- focused current-head green test;
- representative reserve-only-first-pool negative control;
- OpenSpec validation and repository formatting/lint gate appropriate to a
