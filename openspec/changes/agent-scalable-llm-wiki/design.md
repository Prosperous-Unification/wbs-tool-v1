...
(2026-09-13) amends this design before slice 1.1: range-level evidence and sparse
reconciliation (its Part 2) and the day-one extraction constraints (its 3.2).
