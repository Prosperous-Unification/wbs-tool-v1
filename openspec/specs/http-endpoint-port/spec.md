# http-endpoint-port Specification

## Purpose

Define the shared HTTP endpoint contract used by backend bindings, generated
documents and tools, and frontend clients while preserving request policy,
validation, reply representation, refresh, authentication, and marker behavior.
