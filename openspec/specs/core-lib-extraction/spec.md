...
Defines the enforced architectural rings, portable application core, source contracts, and verification obligations for moving backend behavior out of its runtime adapter.
