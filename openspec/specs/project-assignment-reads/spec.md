# Project Assignment Reads Specification

## Purpose

Bound assignment and assigned-name reads to the project or work item that requested them while preserving existing assignment consumers.
