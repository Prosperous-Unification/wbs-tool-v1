...
| WbsTableProps, SubscriptionHandlers, PlanReadScope (there was never a `readScopeFor`; corrected 2026-09-08); authoritative read state; refresh, stale reread, subscription, run and stepStack; placementsOf, hoveredCellAfterRefresh, sameSteps | use-plan-read         |
